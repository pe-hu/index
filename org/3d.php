...
<body>
    <ol id="about" class="org">
        ...
        <p>品目に、<span class="popup"></span> の 表記があるものを、BnA Alter Meuseum で 展示・販売しているものです。
        <br/>詳細 : <a href="https://bnaaltermuseum.com/event/the-things-i-we-own/" target="_blank">bnaaltermuseum.com/event/the-things-i-we-own/</a></p>
        <br/>
